...
#         bins0, used_time0 = FFDSum_simple(init_popu0, addtion0)
#         bins1, used_time1 = FFDSum_complex(init_popu1, addtion0)
#         bins2, used_time2 = FFDSum_simple(init_popu2, addtion0)
#         bins3, used_time3 = FFDSum_complex(init_popu3, addtion0)
...
#         addtion_scale = num_init_docker + sum(addtion0['replicas'])
...
if __name__ == '__main__':
    ...
    # 产生新初始集群
    init_popu0 = main_init(100, 1.0)
    cycle = [10, 30, 40, 60, 80, 100, 120, 140, 160, 170, 190, 200, 210, 230, 250, 280,  300, 320, 350, 370, 390, 400, 420, 450, 470, 490, 500, 504, 540, 600, 650, 680, 700, 1000, 1500, 2000, 3000, 4000, 5000, 6000]#, 10000, 20000, 30000]
    # 模拟多批量新增场景
    for scale in cycle:
        ...
        # 记录各次迭代集群数据
        data['scale'].append(scale_init)
        data['simple'].append(cost_simple)
        data['complex'].append(cost_complex)
        data['safe_simple'].append(0)
        data['safe_complex'].append(0)
